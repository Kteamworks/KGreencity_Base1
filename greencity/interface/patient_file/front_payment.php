...
<input type='submit' name='form_save' value='<?php echo htmlspecialchars( xl('Generate Invoice'), ENT_QUOTES);?>' onclick = "this.style.visibility='hidden', loading.style.visibility='visible',cncl.style.visibility='hidden'" /> &nbsp;
 
<input type='button' value='<?php echo xla('Cancel'); ?>' name='cncl' onclick='window.close()' />
