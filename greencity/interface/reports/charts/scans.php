<html>
 ...
 /* function line_chart() 
			...
			success: function(jsonData)
				{
					...
					chart.draw(data, {width: 800, height: 840});
  ...
  <body>
	...
	<h1 align='center'>Scans Visit  </h1>
	<div style="font: 21px arial; padding: 10px 0 0 100px;">Percentage of Patients Visit for Scans</div>
   <div id="piechart_div"></div>
   <div style="font: 21px arial; padding: 10px 0 0 100px;">Number of Visits for Scans</div>
