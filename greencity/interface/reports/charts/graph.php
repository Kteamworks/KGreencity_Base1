<html>
 ...
 /* function line_chart() 
  ...
  <body>
	...
	<h1 align='center'>Patient's Visit </h1>
	<div style="font: 21px arial; padding: 10px 0 0 100px;">Percentage of Patients </div>
   <div id="piechart_div"></div>
   <div style="font: 21px arial; padding: 10px 0 0 100px;">Number of Visit</div>
