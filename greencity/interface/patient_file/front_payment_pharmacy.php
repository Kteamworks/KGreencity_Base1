...
$rateplan=$patdata['rateplan'];
	...
	$doctor = $row2['username'];
	if($doctor =='')
	{
		$doctor = $enc1['doctor'];
	}
	echo "<tr><td style='padding-right: 100px;'  >" . xlt('Doctor') . ":&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp" . text($doctor). "</td>";
	echo "<td  style='padding-right: 10px;' >" . xlt('') . " " . text($row2['specialty1']) . "</td></tr>";
