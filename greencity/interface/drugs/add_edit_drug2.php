...
?> 
 ...
 <select name="vat[]" id="<?php echo 'v'.$i?>">
  ...
  <option value="14.50">14.50%</option>
   ...
   <td>
  <input type='text' size="10" name='discount[]' maxlength='80' value='' class="discount" id="<?php echo 'd'.$i; ?>" style='width:100%'  placeholder="00.00%"  />
  </td>
  
  <td>
  <input type='text' size='10' name='total[]' maxlength='80' value='' class="sum" id="<?php echo 't'.$i?>" style='width:100%'  placeholder="00.00" />
  </td>
...
?>
 ...
 <tr><th colspan="15" style="text-align:right">Total Amount: </th><th><input type="text" class="total" id="rgt" value="" /></th><tr> 
