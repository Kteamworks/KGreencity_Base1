...
<div class="col-sm-2">
 ...
 <td>
<input type="number" style="text-align:right;text-align:right;" class="form-control discount" onkeydown="updateNewPrice()" name="discount" value="" placeholder="%" required//></td>
 </tr>
 <tr>
